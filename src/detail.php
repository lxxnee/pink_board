      ...
      <a href="./update.php?no=<?php echo $item["no"]?>&page=<?php echo $page_num?>"><img src="data:image/png;base64,"></a> 
        ...
        <div class="slidewrap">
          <ul class="slidelist">
            ...
            <a href="./detail.php?page=<?php echo $prev_page_num ?>"><label for = "slide02" class="left"></label></a>
                ...
                <a href="./list.php?page=<?php echo $next_page_num ?>"></label></a>
             
              </li>
            <li>
             
            <a href="./detail.php?page=<?php echo $prev_page_num ?>" ><label for = "slide03" class="left"></label></a>
                <div class="item-no"><?php echo $item["no"]?></div>
                <div class="item-title"><?php echo $item["title"]?></div>
                <div class="item-createdat"><?php echo $item["created_at"]?></div>
                <div class="line-title"><?php echo $item["content"]?></div>
            ...
            <a href="./detail.php?page=<?php echo $prev_page_num ?>" ><label for = "slide04" class="left"></label></a>
                <div class="item-no"><?php echo $item["no"]?></div>
                <div class="item-title"><?php echo $item["title"]?></div>
                <div class="item-createdat"><?php echo $item["created_at"]?></div>
                <div class="line-title"><?php echo $item["content"]?></div>
            ...
            <a href="./detail.php?page=<?php echo $prev_page_num ?>" ><label for = "slide01" class="left"></label></a>
                <div class="item-no"><?php echo $item["no"]?></div>
                <div class="item-title"><?php echo $item["title"]?></div>
                <div class="item-createdat"><?php echo $item["created_at"]?></div>
                <div class="line-title"><?php echo $item["content"]?></div>
